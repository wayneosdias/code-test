...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_SLOW_ADV_INT_MAX                  (0x0640u)
    ...
    #define CYBLE_GAPP_CONNECTION_SLAVE_LATENCY     (0x0019u)
...
#define CYBLE_ADV_PKT_INDEX_APPEARANCE   (0x1Bu)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x003Fu == 0u) ? (1u) : (0x003Fu))
